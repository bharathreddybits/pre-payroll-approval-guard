...
import { Scan, ShieldAlert, FileCheck, BookOpen } from 'lucide-react';
...
const values = [
  ...
  {
    icon: BookOpen,
    title: 'Expert-Written Guidance',
    description:
      'Every flagged change includes the reason it was flagged, what usually causes it, and step-by-step review instructions — written by payroll experts, not generated by AI.',
    accent: 'red' as const,
  },
];
